...
from odoo.addons.cyllo_dark_mode.models.res_users import _get_time
...
class TestResUsers(common.TransactionCase):
    ...
    def test_for_fields(self):
        ...
        cron_start = self.env.ref('cyllo_dark_mode.ir_cron_darkmode_schedule_dark_mode_enable').id
        cron_end = self.env.ref('cyllo_dark_mode.ir_cron_darkmode_schedule_dark_mode_disable').id
    ...
    def test_schedule_time_trigger(self):
        ...
        if return_key == 'start_time':
            self.assertEqual(trigger_id.cron_id.id, self.env.ref(
                'cyllo_dark_mode.ir_cron_darkmode_schedule_dark_mode_enable').id)
        else:
            self.assertEqual(trigger_id.cron_id.id, self.env.ref(
                'cyllo_dark_mode.ir_cron_darkmode_schedule_dark_mode_disable').id)
    ...
    def test_schedule_dark_mode_enable(self):
        ...
        cron_id = self.env.ref(
            'cyllo_dark_mode.ir_cron_darkmode_schedule_dark_mode_enable')

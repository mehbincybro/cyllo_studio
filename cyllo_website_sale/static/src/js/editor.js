/** @odoo-module **/
let WebsiteEditorComponentPage = require("@website/components/editor/editor")
...
WebsiteEditorComponentPage.WebsiteEditorComponent = class extends Component {
    /**
     * @override
     */
    setup() {
        ...
        onWillStart(async () => {
            ...
            const adapterModule = await odoo.loader.modules.get('@cyllo_website_sale/js/wysiwyg_adapter');
...
WebsiteEditorComponentPage.WebsiteEditorComponent.template = 'website.WebsiteEditorComponent';
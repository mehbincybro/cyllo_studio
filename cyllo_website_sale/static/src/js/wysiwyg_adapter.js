...
import { PageOption } from "@website/components/wysiwyg_adapter/page_options";
...
//    fix for product card edit in website editor
    async init() {
...
//    end of the fix for product card  init
    /**
     * @override
     */
    async startEdition() {
...
//fixes for product card editing
            const methods = {

...
//            cleanDomFromBootstrap();
            const actionDialogProps = {
                ...
                customClass: action.custom_wizard_class ? action.custom_wizard_class : "",
            };
            ActionDialog.props = {
                ...Dialog.props,
                close: Function,
...
registry.category("services").add("action", CustomActionService, {force: true});
        ...
        class i {
            constructor(e, t = null, n = null) {
                this.events = {}
                    ...
                    , this.container = e, this.precanvas = null, this.nodeId = 1, this.ele_selected = null, this.node_selected = null, this.drag = !1, this.reroute = !1, this.reroute_fix_curvature = !1, this.curvature = .5, this.reroute_curvature_start_end = .5, this.reroute_curvature = .5, this.reroute_width = 6, this.drag_point = !1, this.editor_selected = !1, this.connection = !1, this.connection_ele = null, this.connection_selected = null, this.canvas_x = 0, this.canvas_y = 0, this.pos_x = 0, this.pos_x_start = 0, this.pos_y = 0, this.pos_y_start = 0, this.mouse_x = 0, this.mouse_y = 0, this.line_path = 5, this.first_click = null, this.force_first_input = !1, this.draggable_inputs = !0, this.useuuid = !1, this.parent = n, this.noderegister = {}

                    , this.render = t, this.drawflow = {
                    drawflow: {
                        Home: {
                            data: {}
                        }
            ...
            key(event) {
                if (event.key === "Delete" && !this.connection_selected) {
                    this.dispatch("keydown", event);
                } else if (this.dispatch("keydown", event), this.editor_mode === "fixed" || this.editor_mode === "view") {
                    return false;
                } else if (event.key === "Delete" || (event.key === "Backspace" && event.metaKey)) {
                    if (this.node_selected !== null && this.first_click.tagName !== "INPUT" && this.first_click.tagName !== "TEXTAREA" && !this.first_click.hasAttribute("contenteditable")) {
            ...
            addNodeImport(e, t) {
                ...
                if (c.classList.add("drawflow_content_node"), !1 === e.typenode) c.innerHTML = e.html; else if (!0 === e.typenode) c.appendChild(this.noderegister[e.html].html.cloneNode(!0)); else if (3 === parseInt(this.render.version)) {
                    ...
                    let t = new this.render({
                        parent: this.parent, render: t => t(this.noderegister[e.html].html, {
            ...
            removeNodeInput(e, t) {
                ...
                Object.keys(i.inputs[t].connections).map((function (n, o) {
                    ...
                    s.push({
                        id_output: l, id: e, output_class: c, input_class: t
                    })
            ...
            removeNodeOutput(e, t) {
                ...
                Object.keys(i.outputs[t].connections).map((function (n, o) {
                    ...
                    s.push({
                        id: e, id_input: l, output_class: t, input_class: c
                    })
            ...
            removeSingleConnection(e, t, n, i, multiConnection = false) {
                var s = this.getModuleFromNodeId(e);
                if (s === this.getModuleFromNodeId(t)) {
                    if (this.drawflow.drawflow[s].data[e].outputs[n].connections.findIndex((function (e, n) {
                        ...
                        return this.drawflow.drawflow[s].data[t].inputs[i].connections.splice(l, 1), !multiConnection && this.dispatch("connectionRemoved", {
                            output_id: e, input_id: t, output_class: n, input_class: i
                        }), !0
                    }

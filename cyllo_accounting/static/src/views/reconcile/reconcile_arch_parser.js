...
export class GroupTileArchParser {
    /**
     * Parse the group tiles in the view XML and extract relevant information.
     * @param {Element} arch - The XML element containing the group tiles.
     * @param {Object} models - The models used in the view.
     * @param {string} modelName - The name of the model for the view.
     * @param {string} jsClass - The JavaScript class associated with the view.
     * @returns {Object} - Extracted data including field nodes and buttons.
     */
    parse(arch, models, modelName, jsClass) {
        ...
        visitXML(arch, (node) => {
            if (node.tagName === "button") {
                ...
                const fieldInfo = Field.parseFieldNode(node, models, modelName, "reconcile", jsClass);
...
export class ReconcileArchParser {
/**
     * Parse a field node in the view XML.
     * @param {Element} node - The XML element representing the field.
     * @param {Object} models - The models used in the view.
     * @param {string} modelName - The name of the model for the view.
     * @returns {Object} - Extracted field data.
     */
    parseFieldNode(node, models, modelName) {
        return Field.parseFieldNode(node, models, modelName, "reconcile");
    }
    /**
     * Parse a widget node in the view XML.
     * @param {Element} node - The XML element representing the widget.
     * @param {Object} models - The models used in the view.
     * @param {string} modelName - The name of the model for the view.
     * @returns {Object} - Extracted widget data.
     */
    ...
    /**
     * Process a button node in the view XML.
     * @param {Element} node - The XML element representing the button.
     * @returns {Object} - Extracted button data.
     */
    ...
    /**
     * Parse the view XML and extract relevant information.
     * @param {Document} xmlDoc - The XML document of the view.
     * @param {Object} models - The models used in the view.
     * @param {string} modelName - The name of the model for the view.
     * @returns {Object} - Extracted data including columns, buttons, and more.
     */
    ...
    parse(xmlDoc, models, modelName) {
        ...
        let headerButtons = [];
        const creates = [];
        const groupTileArchParser = new GroupTileArchParser();
        let buttonGroup;
        ...
        visitXML(xmlDoc, (node) => {
            ...
            if (node.tagName === "button") {
                ...
                const groupByArchInfo = groupTileArchParser.parse(node, models, coModelName);
                ...
                // AAB: not sure we need to handle invisible="True" button as the useTileArchParsercase seems way
                ...
                return false;
            } else if (node.tagName === "reconcile") {
                const activeActions = {

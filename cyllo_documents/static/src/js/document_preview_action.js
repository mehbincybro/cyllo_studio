...
class ProductExpiryDashboard extends owl.Component {
    setup() {
...
ProductExpiryDashboard.template = "DocumentPreviewTemplate";
actionRegistry.add('preview_document', ProductExpiryDashboard);
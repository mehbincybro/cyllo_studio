    ...
    parse(arch, models, modelName, jsClass) {
        ...
        visitXML(arch, (node) => {
            if (node.tagName === "button") {
                ...
                const fieldInfo = Field.parseFieldNode(node, models, modelName, "tile", jsClass);
...
/**
    ...
    parseFieldNode(node, models, modelName) {
        return Field.parseFieldNode(node, models, modelName, "tile");
    }
    /**

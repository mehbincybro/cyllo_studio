...
class PurchaseOrder(models.Model):
    """Inherit purchase.order for adding advance payment option"""
    _inherit = "purchase.order"

    advance_payment_ids = fields.One2many(comodel_name="account.payment", inverse_name="purchase_id",
                                          help="Advance payments related to this purchase order")

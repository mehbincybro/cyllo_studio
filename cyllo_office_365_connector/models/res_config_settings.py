...
class ResConfigSettings(models.TransientModel):
    ...
    contact_office_access_token = fields.Char(
        string="Office 365 Access Token",
        config_parameter="cyllo_office_365_connector.contact_office_access_token")
    ...
    office_todo_access_token = fields.Char(
        string="Office 365 Access Token",
        config_parameter="cyllo_office_365_connector.office_todo_access_token")

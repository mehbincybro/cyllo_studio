...
- Full audit trail via chatter
    ...
    'data': [
        'security/cyllo_loan_security.xml',
        'security/ir.model.access.csv',
        'data/cyllo_loan_sequence_data.xml',
        'data/cyllo_loan_type_data.xml',
        'views/cyllo_loan_type_views.xml',
        'views/cyllo_loan_views.xml',
        'views/cyllo_loan_repayment_views.xml',
        'views/cyllo_loan_menu_views.xml',
        'wizards/cyllo_loan_disburse_wizard_views.xml',
        'wizards/cyllo_loan_close_wizard_views.xml',
        'reports/cyllo_loan_report_views.xml',
        'reports/report_cyllo_loan_schedule.xml',
    ],
    'license': 'LGPL-3',
    'installable': True,
    'application': True,

...
class CustomerPortal(portal.CustomerPortal):
    ...
    def create_venue_booking_management(self, page=1, date_begin=None,
        ...
        values.update({
            'cyllo_occasion_management': venue_booking_management,
            'venues': venue,
            'pager': pager,
        })
        return request.render(
            "cyllo_occation_management.portal_my_venue_booking_documents",
            values)
    ...
    def portal_my_venue_booking(self, record):
        ...
        return http.request.render(
            'cyllo_occasion_management.booking_portal_form',
